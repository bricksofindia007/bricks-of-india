...
describe('passesAutoPublishGates', () => {
  const baseOutcome = (): GenerationOutcome => ({
    ...
    lintResult: {
      overallPass: true,
      warnings: [],
      gates: { wordCount: { pass: true, severity: 'ok' }, indiaParagraph: { pass: true, severity: 'ok' }, verdict: null, factuality: { pass: true, severity: 'ok' }, sourceFidelity: { pass: true, severity: 'ok' }, openerUniqueness: null, duplicateContent: null },
    },
    hardRules: [],
    hardFail: false,
  });
