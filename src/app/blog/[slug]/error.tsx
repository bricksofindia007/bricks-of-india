...
export default function BlogPostError({ reset }: Props) {
  return (
    <div className="bg-white min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="text-6xl mb-4">🧱</div>
        <h1 className="font-heading text-dark text-3xl mb-3">Post temporarily unavailable</h1>
        <p className="text-gray-500 font-body mb-6">
          We couldn&apos;t load this post right now. Try again shortly.
        </p>
