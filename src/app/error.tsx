  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="font-heading text-dark text-3xl mb-3">Something went wrong</h1>
        <p className="text-gray-500 font-body mb-6">
          We hit an unexpected error. Try refreshing — if it keeps happening, head back home.
        </p>
